...
const companyLinks = [
  ...
  { name: "Investors", href: "/finance" },
  { name: "Press Kit", href: "/new-cars" },
  { name: "Careers", href: "/referral" },
  { name: "News", href: "/new-cars" },
  { name: "Sustainability", href: "/services" },
];

const discoverLinks = [
  { name: "Buy used car", href: "/buy-car" },
  { name: "Sell used car", href: "/sell-car" },
  { name: "Used car valuation", href: "/finance" },
  { name: "Service centers", href: "/services" },
  { name: "Check vehicle details", href: "/buy-car" },
  { name: "Scrap your car", href: "/services" },
];
...
const supportLinks = [
  ...
  { name: "Customer charter", href: "/services" },
  { name: "Terms & conditions", href: "/services" },
];
